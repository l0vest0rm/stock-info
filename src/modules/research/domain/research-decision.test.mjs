...
test("research decision never promotes incomplete evidence to an action", () => {
  const result = buildResearchDecision({ currentMultiples: { peTtm: 20, pb: 2 }, klineRows: rows, evidenceCount: 0, confirmedEvidenceCount: 0, conflictingEvidenceCount: 0, activeCandidateCount: 0, pressureImpactCount: 0, supportImpactCount: 0 });
...
test("research decision prioritizes conflicting evidence over valuation", () => {
  const result = buildResearchDecision({ currentMultiples: { peTtm: 20, pb: 2 }, klineRows: rows, evidenceCount: 2, confirmedEvidenceCount: 1, conflictingEvidenceCount: 1, activeCandidateCount: 0, pressureImpactCount: 1, supportImpactCount: 0 });
