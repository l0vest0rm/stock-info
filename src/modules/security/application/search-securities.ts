...
export async function searchSecurities(db: Database, q: string): Promise<SecurityRecord[]> {
...
export async function getSecurity(db: Database, code: string): Promise<SecurityRecord | null> {
