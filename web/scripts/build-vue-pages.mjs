...
const pageEntries = [
  ...
  {
    entry: 'src/modules/research/pages/investment-analysis-compare-page.ts',
    globalName: 'LicaiInvestmentAnalysisComparePage',
    fileName: 'js/investment-analysis-compare-page.js',
  },
  {
