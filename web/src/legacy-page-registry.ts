...
async function createPortfolioPageInitializer(context: LegacyPageRegistryContext): Promise<PageInitializer> {
  const [{ createPortfolioInitializer }, { createPortfolioRuntime }] = await Promise.all([
    import('./misc-pages-runtime'),
    import('./portfolio-runtime'),
  ])
...
async function createKnowledgeNewsPageInitializer(context: LegacyPageRegistryContext): Promise<PageInitializer> {
  const { createKnowledgeNewsInitializer } = await import('./knowledge-news-runtime')
...
export async function loadLegacyPageInitializer(page: string, context: LegacyPageRegistryContext): Promise<PageInitializer | null> {
  switch (page) {
    case '':
    case 'index.html': {
      const { createIndexInitializer } = await import('./index-runtime')
    ...
    case '13f.html': {
      const { createThirteenFInitializer } = await import('./thirteenf-runtime')
    ...
    case '13f-position.html': {
      const { createThirteenFPositionInitializer } = await import('./thirteenf-position-runtime')
    ...
    case 'companies-filter.html': {
      const { createCompaniesFilterInitializer } = await import('./companies-filter-runtime')
    ...
    case 'companies-change.html': {
      const { createCompaniesChangeInitializer } = await import('./companies-change-runtime')
      return createCompaniesChangeInitializer({
        fetchRequest: context.fetchRequest,
      })
    }
    case 'sector-flow.html': {
      const { createSectorFlowInitializer } = await import('./sector-flow-runtime')
      return createSectorFlowInitializer({
        fetchRequest: context.fetchRequest,
      })
    }
    case 'companies-follow.html': {
      const { createCompaniesFollowInitializer } = await import('./companies-follow-runtime')
    ...
    case 'companies-holding.html': {
      const { createCompaniesHoldingInitializer } = await import('./companies-holding-runtime')
    ...
    case 'company-dividend.html': {
      const { createCompanyDividendInitializer } = await import('./company-dividend-runtime')
    ...
    case 'company-holders.html': {
      const { createCompanyHoldersInitializer } = await import('./company-holders-runtime')
    ...
    case 'company-notice.html': {
      const { createCompanyNoticeInitializer } = await import('./company-notice-runtime')
    ...
    case 'company-option.html': {
      const { createCompanyOptionInitializer } = await import('./company-option-runtime')
    ...
    case 'company-report-predict.html': {
      const { createCompanyReportPredictInitializer } = await import('./company-report-predict-runtime')
    ...
    case 'company-finance.html': {
      const { createCompanyFinanceInitializer } = await import('./company-pages-runtime')
    ...
    case 'company.html': {
      ...
      } = await import('./company-pages-runtime')
    ...
    case 'funds.html': {
      const { createFundsInitializer } = await import('./funds-runtime')
    ...
    case 'index-position.html': {
      ...
      } = await import('./fund-pages-runtime')
    ...
    case 'info.html': {
      const { createInfoInitializer } = await import('./info-runtime')
    ...
    case 'knowledge-config.html': {
      const { createKnowledgeConfigInitializer } = await import('./knowledge-config-runtime')
    ...
    case 'stock-table.html': {
      const { createStockTableInitializer } = await import('./misc-pages-runtime')
